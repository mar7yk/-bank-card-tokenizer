...
public class LoginController {
    ...
    public void btnSubmit() throws IOException {
        boolean isLogin = Client.getInstants().login(txtUsername.getText(), txtPassword.getText());
    ...
    @FXML
    public void btnRegist() throws IOException {

        Stage stage = Stages.getRegistStage();
        stage.show();
    }
}